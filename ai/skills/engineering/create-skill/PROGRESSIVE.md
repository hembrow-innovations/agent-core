...
- **Prompt** (`ai/prompts/<category>/<name>.md`, dest `.pi/prompts/<name>.md`): user-invoked single-shot entry (`/name`). Thin wrappers may load a skill then run; pure one-liners live only as prompts (no skill folder).
