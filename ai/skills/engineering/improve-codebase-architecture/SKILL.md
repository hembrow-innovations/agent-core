...
Then use a read-only subagent (scout or reviewer) to walk the codebase. Don't follow rigid heuristics — explore organically and note where you experience friction:
