...
> **Note:**  
> This document is the upstream Vercel reference. It contains Next.js, RSC, and SWR patterns
> that do **not** apply to life-engine. See [SKILL.md](SKILL.md) for stack-specific guidance
> and the individual `rules/*.md` files for adapted TanStack Start equivalents.
>
> **Do not apply Next.js patterns** (`next/dynamic`, `after()`, `useSWR`) directly from
> this document — use the adapted rule files instead.
