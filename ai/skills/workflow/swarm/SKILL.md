...
4. Pick the worker model from `swarm workers` in `.pi/draconic-models.md` or `.opencode/rules/draconic-models.md` when present. Otherwise use `grok-4.6-fast-xhigh`. For a model race, name each arm's model up front.
