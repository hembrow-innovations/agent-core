...
1. Search `.heio/` for the same problem, plan, or task. Include `closed/`.
...
A loose thought with no ticket yet is a dump in `.heio/inbox/`. Promote it to an issue when it becomes work.
