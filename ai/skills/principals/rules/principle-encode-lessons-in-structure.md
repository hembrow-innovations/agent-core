...
impact: HIGH
impactDescription: Second reminders do not enforce
tags: [meta, structure]
---

## Encode Lessons in Structure

**Incorrect:** Write the same instruction a second time in AGENTS.md.
**Correct:** Encode it as a lint, banned API, unrepresentable state, or script. Delete the reminder.
