...
impact: HIGH
impactDescription: Inner nil-checks fake safety
tags: [arch, boundary]
---

## Boundary Discipline

**Incorrect:** Validate again inside business logic, or leak wire types through the public surface.
**Correct:** Parse at the CLI, config, network, or API edge. Trust internal types. Keep logic pure.
