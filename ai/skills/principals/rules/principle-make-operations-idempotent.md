...
impact: MEDIUM
impactDescription: Partial reruns become debugging sessions
tags: [arch, ops]
---

## Make Operations Idempotent

**Incorrect:** Assume a clean start. Leave leftover state that changes the next run.
**Correct:** Scan, adopt, or clean. A second run converges to the same end state.
