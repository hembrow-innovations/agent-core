...
impact: HIGH
impactDescription: Hand edits cannot be rerun
tags: [core, lever]
---

## Build the Lever

**Incorrect:** Touch every call site by hand, or fan out delegates to apply the same recipe.
**Correct:** Build the codemod, script, generator, or delegate skill. The reviewer reruns that file.
