...
impact: LOW
impactDescription: One-caller wrappers hide the answer
tags: [craft, readability]
---

## Minimize Reader Load

**Incorrect:** Add a pass-through wrapper or another piece of hidden state.
**Correct:** Collapse the layer. Shrink mutable scope. A new reader finds X in under 30 seconds.
