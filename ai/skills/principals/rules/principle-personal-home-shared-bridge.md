---
title: Personal Home, Shared Bridge
impact: CRITICAL
impactDescription: A shared home splits ownership
tags: [product, engine, share]
---

## Personal Home, Shared Bridge

**Incorrect:** Put the domain row on the shared engine so the household can see it.
**Correct:** Personal engine owns the record. Shared engine holds Shares. Projection is a mirror.
