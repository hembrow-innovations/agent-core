...
impact: HIGH
impactDescription: Scattered branches become the product
tags: [arch, domain]
---

## Model the Domain

**Incorrect:** Grow the if/else chain by one more `engineType ===` branch.
**Correct:** Encode the domain in a structure. State machine, typed model, table, or reducer.
