...
5. Route situational skills (`how`, `why`, `architect`, `arena`, `swarm`, `tdd`, `unslop`, `technical-writing`, and any project `verify-*` skill) via Skill tool or `/command` as steps fire.
