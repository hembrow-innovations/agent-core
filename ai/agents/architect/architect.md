...
Handoff is a file, not chat memory. Write the sketch where the brief named. If the brief named no path, write under `.draconic/planning/plans/` next to the plan.
