---
description: What else a small change could break
...
6. For a big or wide change, run `/arena`. Ask several models the same question and merge the answers. Different models catch different real bugs.
