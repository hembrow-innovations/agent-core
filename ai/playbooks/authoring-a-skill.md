...
1. Use the **create-skill** skill (`ai/skills/engineering/create-skill`). A large knowledge pack (many independent rules) goes through `/create-progressive-skill` instead of one fat SKILL.md.
