...
1. Load skill **`draconic-mode`** via the Skill tool and read it in full, including the Principles index.
2. Open a todo list and write `.draconic/TODO.md`. First item is reading those principles.
