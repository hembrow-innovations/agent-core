...
Transcripts live under `~/.pi/agent/sessions/` for this working directory, or the path in `PI_SESSION_FILE`. They are JSONL session trees. Do not read Cursor `agent-transcripts/` unless the user points at them.
