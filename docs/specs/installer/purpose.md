...
Install a profile's stacks, skills, agents, and prompts into a dest OpenCode tree the dest can commit without this checkout.

## In scope

- Install from this repo only
- Profile install of stacks, skills, agents, and prompts
...
- Copy of playbooks or deprecated Pi runtime markdown
