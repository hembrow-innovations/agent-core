...
1. Spawn `draconic_spawn` with `readonly: true` and tell the child to read `/skill:comment-sicko` then report kills for the scope. If spawn is missing, read `.pi/skills/comment-sicko/SKILL.md` and apply it yourself.
