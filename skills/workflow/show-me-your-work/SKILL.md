...
At the end of the run, before handing back, check the log told the truth. Read this run's Pi session (`PI_SESSION_FILE` or `~/.pi/agent/sessions/` for this cwd). Walk the log against what actually happened:
