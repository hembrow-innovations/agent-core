...
The parent finds its own transcript before fanning out. Use `PI_SESSION_FILE` or `~/.pi/agent/sessions/` for this working directory. Do not glob across other projects' sessions.
