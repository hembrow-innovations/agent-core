...
**Pattern:**
- **Isolate large payloads.** Route verbose outputs, screenshots, and large documents to `draconic_spawn` or a summary file. The main context gets summaries, not raw data.
