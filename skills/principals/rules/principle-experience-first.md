...
impact: LOW
impactDescription: Easy-to-build shapes hurt the user
tags: [craft, ux]
---

## Experience First

**Incorrect:** Ship the shape that is convenient to implement.
**Correct:** Choose the experience. Fewer polished features beat more rough ones.
