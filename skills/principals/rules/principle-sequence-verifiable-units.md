...
impact: HIGH
impactDescription: Batched edits bury the break
tags: [prove, sequence]
---

## Sequence work into verifiable units

**Incorrect:** Do the whole sweep, then verify once at the end.
**Correct:** One unit, one check, then the next. Red then green in the commit stack.
...
The sequencing complement to `principle-prove-it-works`, which keeps each check real, and `principle-build-the-lever`, which makes the per-unit check cheap.
