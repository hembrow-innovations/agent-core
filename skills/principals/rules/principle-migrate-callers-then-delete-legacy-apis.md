...
impact: MEDIUM
impactDescription: Dual APIs become append-only
tags: [arch, api]
---

## Migrate Callers Then Delete Legacy APIs

**Incorrect:** Keep the old internal API because callers still exist.
**Correct:** Inventory callers, migrate them, delete the old API in the same wave.
